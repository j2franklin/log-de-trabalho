...
const tarefas = {
    ...
    tarefasItens: [
        ...
        { name: 'Trabalhando no arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '17/07/2025', dataFinal: '25/07/2025', started: true, check: false, used: true },
        { name: 'Finalizando arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '25/07/2025', dataFinal: '31/07/2025', started: false, check: false, used: true },
        { name: 'Aprovação de projeto gráfico', categoria: 'Aprovações', dataInicio: '18/07/2025', dataFinal: '28/07/2025', started: true, check: false, used: true },
        { name: 'Aprovação de diagramação', categoria: 'Aprovações', dataInicio: '31/07/2025', dataFinal: '04/08/2025', started: false, check: false, used: true },
        ...
        { name: 'Finalizando projeto web', categoria: 'Web', dataInicio: '30/07/2025', dataFinal: '07/07/2025', started: false, check: false, used: true },
        { name: 'Revisão de projeto web', categoria: 'Revisão', dataInicio: '07/07/2025', dataFinal: '08/08/2025', started: false, check: false, used: true },
        { name: 'Fechamento de diagramação (InDesign)', categoria: 'Fechamentos', dataInicio: '23/07/2025', dataFinal: '06/08/2025', started: false, check: false, used: true },
        { name: 'Fechamento de projeto web', categoria: 'Fechamentos', dataInicio: '04/08/2025', dataFinal: '08/08/2025', started: false, check: false, used: true },
        { name: 'Período de revisão gratuita', categoria: 'Fechamentos', dataInicio: '08/08/2025', dataFinal: '09/09/2025', started: false, check: false, used: true },
