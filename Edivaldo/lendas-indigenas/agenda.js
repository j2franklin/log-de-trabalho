...
const tarefas = {
    ...
    tarefasItens: [
        ...
        { name: 'Capitando imagens', categoria: 'Preparativos', dataInicio: '20/07/2025', dataFinal: '12/09/2025', started: true, check: false, used: true },
        ...
        { name: 'Trabalhando no arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '17/07/2025', dataFinal: '11/09/2025', started: true, check: false, used: true },
        { name: 'Finalizando arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '11/09/2025', dataFinal: '15/09/2025', started: false, check: false, used: true },
        { name: 'Aprovação de projeto gráfico', categoria: 'Aprovações', dataInicio: '15/09/2025', dataFinal: '16/09/2025', started: true, check: false, used: true },
        { name: 'Aprovação de diagramação', categoria: 'Aprovações', dataInicio: '16/09/2025', dataFinal: '16/09/2025', started: false, check: false, used: true },
        { name: 'Revisões de diagramação', categoria: 'Revisão', dataInicio: '04/08/2025', dataFinal: '05/08/2025', started: false, check: false, used: true },
        { name: 'Criação do projeto web', categoria: 'Web', dataInicio: '10/09/2025', dataFinal: '10/09/2025', started: false, check: false, used: true },
        { name: 'Trabalhando no projeto web', categoria: 'Web', dataInicio: '10/09/2025', dataFinal: '15/09/2025', started: false, check: false, used: true },
        { name: 'Finalizando projeto web', categoria: 'Web', dataInicio: '15/09/2025', dataFinal: '17/09/2025', started: false, check: false, used: true },
        { name: 'Revisão de projeto web', categoria: 'Revisão', dataInicio: '15/09/2025', dataFinal: '16/09/2025', started: false, check: false, used: true },
        { name: 'Fechamento de diagramação (InDesign)', categoria: 'Fechamentos', dataInicio: '16/09/2025', dataFinal: '17/09/2025', started: false, check: false, used: true },
        { name: 'Fechamento de projeto web', categoria: 'Fechamentos', dataInicio: '17/09/2025', dataFinal: '18/09/2025', started: false, check: false, used: true },
        { name: 'Período de revisão gratuita', categoria: 'Fechamentos', dataInicio: '18/09/2025', dataFinal: '01/11/2025', started: false, check: false, used: true },
        { name: 'PROJETO FECHADO', categoria: 'Fechamentos', dataInicio: '01/11/2025', dataFinal: '02/11/2025', started: false, check: false, used: true },
    ]
}
