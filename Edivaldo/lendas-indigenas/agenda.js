...
const tarefas = {
    ...
    tarefasItens: [
        ...
        { name: 'Aprovação de projeto gráfico', categoria: 'Aprovações', dataInicio: '18/07/2025', dataFinal: '21/07/2025', started: false, check: false, used: true },
        { name: 'Aprovação de diagramação', categoria: 'Aprovações', dataInicio: '21/07/2025', dataFinal: '25/07/2025', started: true, check: false, used: true },
