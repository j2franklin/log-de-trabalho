...
const tarefas = {
    ...
    tarefasItens: [
        { name: 'Acerto do orçamento', categoria: 'Preparativos', dataInicio: '05/08/2025', dataFinal: '06/08/2025', started: true, check: false, used: true },
        { name: 'Preparando o espaço de trabalho', categoria: 'Preparativos', dataInicio: '05/08/2025', dataFinal: '06/08/2025', started: true, check: false, used: true },
        { name: 'Capitando imagens', categoria: 'Preparativos', dataInicio: '05/08/2025', dataFinal: '08/08/2025', started: false, check: false, used: true},
        { name: 'Capitando originais', categoria: 'Preparativos', dataInicio: '06/08/2025', dataFinal: '12/08/2025', started: true, check: false, used: true },
        { name: 'Criando lista de fontes', categoria: 'Pré-diagramação', dataInicio: '05/08/2025', dataFinal: '08/08/2025', started: false, check: false, used: true },
        { name: 'Criando lista de estilos', categoria: 'Pré-diagramação', dataInicio: '05/08/2025', dataFinal: '08/08/2025', started: false, check: false, used: true },
        { name: 'Criando arquivo de formatação (word)', categoria: 'Pré-diagramação', dataInicio: '05/08/2025', dataFinal: '05/08/2025', started: true, check: true, used: true },
        { name: 'Trabalhando no arquivo de formatação (word)', categoria: 'Pré-diagramação', dataInicio: '06/08/2025', dataFinal: '07/08/2025', started: false, check: false, used: true },
        { name: 'Finalizando arquivo de formatação (word)', categoria: 'Pré-diagramação', dataInicio: '07/08/2025', dataFinal: '07/08/2025', started: false, check: false, used: true },
        { name: 'Criando arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '07/08/2025', dataFinal: '07/08/2025', started: false, check: false, used: true },
        { name: 'Criando projeto gráfico (InDesign)', categoria: 'Diagramação', dataInicio: '07/08/2025', dataFinal: '11/08/2025', started: false, check: false, used: true },
        { name: 'Trabalhando no arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '13/08/2025', dataFinal: '15/08/2025', started: false, check: false, used: true },
        { name: 'Finalizando arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '12/08/2025', dataFinal: '13/08/2025', started: false, check: false, used: true },
        { name: 'Aprovação de projeto gráfico', categoria: 'Aprovações', dataInicio: '13/08/2025', dataFinal: '14/08/2025', started: false, check: false, used: true },
        { name: 'Aprovação de diagramação', categoria: 'Aprovações', dataInicio: '15/08/2025', dataFinal: '17/08/2025', started: false, check: false, used: true },
        { name: 'Revisões de diagramação', categoria: 'Revisão', dataInicio: '17/08/2025', dataFinal: '18/08/2025', started: false, check: false, used: true },
        { name: 'Criação do projeto web', categoria: 'Web', dataInicio: '19/08/2025', dataFinal: '19/08/2025', started: false, check: false, used: true },
        { name: 'Trabalhando no projeto web', categoria: 'Web', dataInicio: '19/08/2025', dataFinal: '21/08/2025', started: false, check: false, used: true },
        { name: 'Finalizando projeto web', categoria: 'Web', dataInicio: '22/08/2025', dataFinal: '24/08/2025', started: false, check: false, used: true},
        { name: 'Revisão de projeto web', categoria: 'Revisão', dataInicio: '21/08/2025', dataFinal: '22/08/2025', started: false, check: false, used: true },
        { name: 'Fechamento de diagramação (InDesign)', categoria: 'Fechamentos', dataInicio: '18/08/2025', dataFinal: '19/08/2025', started: false, check: false, used: true },
        { name: 'Fechamento de projeto web', categoria: 'Fechamentos', dataInicio: '24/08/2025', dataFinal: '25/08/2025', started: false, check: false, used: true },
        { name: 'Período de revisão gratuita', categoria: 'Fechamentos', dataInicio: '26/08/2025', dataFinal: '26/09/2025', started: false, check: false, used: true },
        { name: 'PROJETO FECHADO', categoria: 'Fechamentos', dataInicio: '26/08/2025', dataFinal: '27/09/2025', started: false, check: false, used: true},
    ]
}
...
const projeto = {
    ...
    descricao: `?`,
    dimensoes: [0, 0],
    isbnFisico: '000-00-000000-0-0 (fisico)',
    isbnDigital: '000-00-000000-0-0 (digital)',
    relevantes: '...'
}
