...
const tarefas = {
    ...
    tarefasItens: [
        { name: 'Acerto do orçamento', categoria: 'Preparativos', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Preparando o espaço de trabalho', categoria: 'Preparativos', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Capitando imagens', categoria: 'Preparativos', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Capitando originais', categoria: 'Preparativos', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Criando lista de fontes', categoria: 'Pré-formatação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Criando lista de estilos', categoria: 'Pré-formatação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Criando arquivo de formatação (word)', categoria: 'Pré-formatação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Trabalhando no arquivo de formatação (word)', categoria: 'Pré-formatação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Finalizando arquivo de formatação (word)', categoria: 'Pré-formatação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Criando arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Criando projeto gráfico (InDesign)', categoria: 'Diagramação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Trabalhando no arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
        { name: 'Finalizando arquivo de diagramação (InDesign)', categoria: 'Diagramação', dataInicio: '10/07/2025', dataFinal: '27/07/2025', started: false, check: false, used: true },
    ]
}
